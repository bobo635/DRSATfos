...
error(){
    sleep 2
    echo -ne '\n'"--PROBLEM!--"
    echo -ne '\n'"Support: https://github.com/bobo635/DRSATfos" '\n'
exit
}
...
packages_install(){
    ...
    wget https://sourceforge.net/projects/restream/files/fos-streaming_unpack_x84_64.tar.gz -O /home/fos-streaming/fos-streaming_unpack_x84_64.tar.gz  > /dev/null 2>&1
    ...
    git clone https://github.com/bobo635/DRSATfos.git  > /dev/null 2>&1
...
ffmpeg()
{
    wget https://sourceforge.net/projects/restream/files/ffmpeg-release-64bit-static.tar.xz -O /home/fos-streaming/ffmpeg-release-64bit-static.tar.xz  > /dev/null 2>&1
